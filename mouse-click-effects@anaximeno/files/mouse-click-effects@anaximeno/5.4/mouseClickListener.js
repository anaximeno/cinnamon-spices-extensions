...
var MouseClickListener = class MouseClickListener {
    ...
    start() {
        ...
        logInfo('MouseClickListener started ' + (this._active ? 'successfuly' : 'successfuly'));
    }
    ...
    stop() {
        ...
        if (this._pointer_button_signal_id) {
            Meta.get_backend().disconnect(this._pointer_button_signal_id);
            this._pointer_button_signal_id = 0;
    ...
    _start_pointer_button_signal() {
        try {
            this._pointer_button_signal_id = Meta.get_backend().connect(
                'pointer-button', (backend, button, pressed) => {
